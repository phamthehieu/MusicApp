...
import com.example.musicapp.activities.MoreArtistsActivity
import com.example.musicapp.databinding.FragmentSettingAdminBinding
...
class SettingAdminFragment : Fragment() {
    ...
    private lateinit var binding: FragmentSettingAdminBinding
    ...
    companion object {
        const val EDIT_PROFILE_REQUEST_CODE = 1001
    }
    ...
    override fun onCreateView(
        ...
        binding.moreArtists.setOnClickListener {
            startActivity(Intent(requireContext(), MoreArtistsActivity::class.java))
        }
